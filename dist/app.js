...
class ProjectInput {
    ...
    gatherUserInput() {
        ...
        if (!validate(titleValidatable) ||
            ...
            alert("Invalid input, plerase try again!");
            return;
        }
        else {
...
__decorate([
    Autobind
], ProjectInput.prototype, "submitFormHandler", null);
new ProjectInput();
let activList = new ProjectList("active");
let finishedList = new ProjectList("finished");
